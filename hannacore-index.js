import { eventSource, event_types, extension_settings, saveSettingsDebounced, getContext } from '../../../extensions.js';
...
jQuery(async () => {
    ...
    const html = `
<div id="hc-root" style="padding:8px 0">
    <div style="font-weight:700;color:#cba6f7;margin-bottom:10px;font-size:13px;">⚙ Hannacore</div>
    ...
    <input type="password" id="hc-gh" value="${cfg().githubToken || ''}" style="width:100%;background:#0d0e17;border:1px solid #2a2b3d;border-radius:5px;color:#c0caf5;font-size:12px;padding:5px 7px;margin-bottom:6px;box-sizing:border-box;">

    <label style="font-size:11px;color:#9aa5ce;">Gist ID</label>
    <input type="text" id="hc-gist" value="${cfg().gistId || ''}" style="width:100%;background:#0d0e17;border:1px solid #2a2b3d;border-radius:5px;color:#c0caf5;font-size:12px;padding:5px 7px;margin-bottom:6px;box-sizing:border-box;">

    <label style="font-size:11px;color:#9aa5ce;">DeepSeek API Key</label>
    <input type="password" id="hc-ds" value="${cfg().deepseekApiKey || ''}" style="width:100%;background:#0d0e17;border:1px solid #2a2b3d;border-radius:5px;color:#c0caf5;font-size:12px;padding:5px 7px;margin-bottom:8px;box-sizing:border-box;">

    <div style="display:flex;gap:6px;margin-bottom:12px;">
        <button id="hc-save" style="flex:1;padding:7px;background:#a6e3a1;color:#1e1e2e;border:none;border-radius:5px;font-weight:700;cursor:pointer;font-size:12px;">Salvar</button>
